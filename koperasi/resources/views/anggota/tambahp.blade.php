...
<body>
    ...
    <div class="col-md-4 col-md-offset-4">
        ...
        <div style="height: 330px;">
			{!! Form::open(['url'=>'anggota/pinjaman','class'=>'form-horizontal','style'=>'top: 20px; margin-right: 10px;']) !!}
			@include('anggota.pinjam')
			<div style="width:100%;text-align:right;margin-bottom: 15px;margin-top: 100px;">
